...
//        registerNetworkChangeReceiver();
    ...
    /**
     * 该方法紧接着setContentView()调用，有时activity存在继承关系，需要在setContentView()方法后做些操作，比如子类需要的额外的view
     */
...
//        MobclickAgent.onResume(this);
    ...
    public void setCheckLoginState(boolean checkLoginState) {
        isCheckLoginState = checkLoginState;
    }
...
/*    private void startToBackgroundService() {
    ...
    public void showEmptyErrorView(int errorCode, String message) {
        ...
        if (mEmptyView == null) {
            mEmptyView = View.inflate(this, com.art.recruitment.common.R.layout.view_empty_error, null);
...
//                mEmptyErrorImage.setImageResource(com.art.recruitment.common.R.drawable.empty_error_view_no_integral);
