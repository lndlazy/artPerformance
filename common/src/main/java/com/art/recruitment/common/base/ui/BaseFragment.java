...
//                    getRecyclerView().smoothScrollToPosition(0);
    ...
    public void showEmptyErrorView(int errorCode, String message) {
        ...
        if (mEmptyView == null) {
            mEmptyView = View.inflate(mContext, com.art.recruitment.common.R.layout.view_empty_error, null);
            mEmptyErrorImage = mEmptyView.findViewById(com.art.recruitment.common.R.id.view_empty_error_image);
            mEmptyErrorTipText = mEmptyView.findViewById(com.art.recruitment.common.R.id.view_empty_error_tip);
...
//                    mEmptyErrorImage.setImageResource(com.art.recruitment.common.R.drawable.empty_error_view_no_network);
