...
public class EaseCommonUtils {
    ...
    public static EaseUser getCurrentUserInfo(String hxId) {

        EaseUser easeUser = new EaseUser(hxId);//环信id
        easeUser.setNickname(SPUtils.getInstance().getString(SpKey.USER_NAME));//昵称
        easeUser.setAvatar(SPUtils.getInstance().getString(SpKey.HEAD_PIC_URL));//头像
        return easeUser;
