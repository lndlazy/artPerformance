...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            if (EaseUserUtils.contactList != null && EaseUserUtils.contactList.containsKey(username)) {

                EaseUser easeUser = EaseUserUtils.contactList.get(username);

                if (easeUser != null) {
                    String nickname = easeUser.getNickname();
                    holder.name.setText(nickname);
                } else holder.name.setText(group != null ? group.getGroupName() : username);
